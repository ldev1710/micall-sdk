...
-(void) createAccountWrapper :(NSString*) usernameNS :(NSString*) passwordNS
                             :(NSString*) registrarNS :(NSString*) portNS :(NSString*) proxyNS
{
    ...
    std::string proxy = std::string([[proxyNS componentsSeparatedByString:@"*"][0] UTF8String]);
    
    pjsua2.createAccount(username, password, registrar, port, proxy);
}
 ...
 */
-(void) acc_listener_wrapper: (void(*)(bool,int))function {
